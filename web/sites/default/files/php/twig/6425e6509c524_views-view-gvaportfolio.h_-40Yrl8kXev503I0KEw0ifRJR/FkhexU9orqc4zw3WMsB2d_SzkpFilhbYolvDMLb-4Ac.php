...
/* themes/custom/inusti_subtheme/templates/views/views-view-gvaportfolio.html.twig */
class __TwigTemplate_acecc0b87ce18195c15c1bca409c9407da297b152e2b2f920aebcc31e76ebdb7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/custom/inusti_subtheme/templates/views/views-view-gvaportfolio.html.twig";
    }
...
{% endif %}
  ...
  <nav class=\"portfolio-filter\">
    <ul class=\"nav nav-tabs\">
      {% if show_all %}
        <li><a class=\"btn-filter {{pid}} all active\" href=\"#\" data-filter=\"*\"><span>{{'All'|t}}</span></a></li>
      {% endif %}
  ...
  <div class=\"gva-portfolio-items clearfix\">
    <div class=\"row\">
      <div class=\"isotope-items view-portfolio\" data-pid=\"{{pid}}\" data-drupal-views-infinite-scroll-content-wrapper-gvaloadmore>
        {% for row in rows %}
          {{ row.content|raw }}
        {% endfor %}
      </div>
...
{% endif %}
", "themes/custom/inusti_subtheme/templates/views/views-view-gvaportfolio.html.twig", "/var/www/html/web/themes/custom/inusti_subtheme/templates/views/views-view-gvaportfolio.html.twig");
    }
