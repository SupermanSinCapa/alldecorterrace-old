      ...
      public function render_form(){
         ...
         for($i = 1; $i <= 4; $i++){
            ...
            $fields['fields'][] = array(
               ...
               'type'         => 'text',
               'title'        => t("Icon {$i}"),
               'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="http://gaviasthemes.com/icons/inusti">Custom icon</a>'),
