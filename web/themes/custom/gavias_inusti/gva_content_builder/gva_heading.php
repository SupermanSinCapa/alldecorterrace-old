   ...
   class element_gva_heading{
            ...
            'fields'    => array(
               ...
               array(
                  ...
                  'options'   => array(
                        ...
                        'padding-bottom-180'     => 'Large padding',
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <div class="widget gsc-heading <?php print implode(' ', $class) ?>"<?php print $style; ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
            ...
            <?php if($button_link){ ?>
               <div class="heading-action clearfix <?php print (empty($desc) ? 'margin-top-50' : 'no-margin'); ?>">
                  <a href="<?php echo $button_link ?>" class="btn-large <?php print $button_style; ?>"><span><?php echo $button_text ?></span></a>
               </div>
            <?php } ?>
