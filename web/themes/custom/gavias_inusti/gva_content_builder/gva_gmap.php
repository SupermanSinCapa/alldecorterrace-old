...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      ?>
         ...
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_inusti')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_inusti')) ?>/vendor/jquery.ui.map.min.js"></script>
